...
import ow.tool.dhtshell.commands.ClientCommand;
import ow.tool.dhtshell.commands.ServerCommand;
...
import ow.tool.dhtshell.commands.TestCommand;
import ow.tool.dhtshell.commands.TestSenderCommand;
...
public final class Main extends AbstractDHTBasedTool<String>
	...
	private final static Class/*Command<<DHT<String>>>*/[] COMMANDS = {
		...
		ClientCommand.class,ServerCommand.class,
...
//		SourceCommand.class,
		...
		TestCommand.class,TestSenderCommand.class
	};
