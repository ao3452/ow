...
public final class MessageDirectory {
	...
	static {
		...
		Class[] rootClasses = {
			...
			ow.tool.dhtshell.commands.ClientCommand.class,
			ow.tool.dhtshell.commands.ServerCommand.class,
/*			ow.tool.dhtshell.DLMessage.class,
			ow.tool.dhtshell.DL2Message.class*/
		};
